...
#define ZAXIS_STEPS_PER_MM 414.4
#define EXTRUDER_FAN_COOL_TEMP 50
#define EXT0_X_OFFSET 0
#define EXT0_Y_OFFSET 0
#define EXT0_STEPS_PER_MM 170
...
#define UI_PRINTER_COMPANY "Sli3DR"
...
#define CASE_LIGHTS_PIN ORIG_Z_MAX_PIN
